...
//  Decides where to move and who to shoot based on the scores for each action.                                   //
//                                                                                                                //
//  UtilityAction: struct | Written by Anthony Pascone                                                            //
//  Holds the score for every action, which can be manipulated as needed.                                         //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public class Utility {
    ...
    struct UtilityAction
    {
        ...
        /// </summary>
        /// <param name="num">The number to be added to the score</param>
        ...
        /// <summary>
        /// Get the current score of this action
        /// </summary>
        /// <returns>The score of this action</returns>
        ...
        /// <summary>
        /// Set the score of this action to zero
        /// </summary>
    ...
    /// <summary>
    /// Set the unit this UtilityAi is on
    /// </summary>
    /// <param name="unit">The EnemyUnit that this UtilityAI is on</param>
    ...
    /// <summary>
    /// Get if the UtilityAI is still running
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Decide which player unit to shoot if one is in range
    /// </summary>
    void ShootAction()
    {
    ...
    /// <summary>
    /// Get the shoot scores of the player unit at index 
    /// </summary>
    /// <param name="index">The index of the unit in the shootables List</param>
    /// <returns>The action with its score fleshed out</returns>
    ...
    /// <summary>
    /// Find the highest score out of all the actions
    /// </summary>
    /// <param name="actions">All the actions this UtilityAi can do</param>
    /// <returns>Integer index of the Action with the highest score</returns>
